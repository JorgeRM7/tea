                                    ...
                                    <form name="formulario" id="formulario" method="POST">
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" id="route" name="route" class="form-control" placeholder="Ingresa..." required/>
                                                <input type="hidden" id="view_id" name="view_id" class="form-control"/>
                                            </div>
                                            <div class="col-md-6">
...
<script>
    ...
    $(document).ready(function() {
        ...
        const menuItem = document.querySelector('a[href="admin-views.php"]').parentElement;
    ...
    const index = () => {
        ...
        tabla = $('#tbllistado').dataTable({
            ...
            // "dom": 'Bfrtip',
            "ajax": {
                url: '../Controllers/adminViewsController.php?op=index',
                type: "get",
                headers: {
                    "Authorization": "Bearer " + token
                },
    ...
    const show = ( view_id ) => {
        $('#modal_create').modal('show');
        $.ajax({
            url: "../Controllers/adminViewsController.php?op=show",
            type: "POST",
            headers: {
                "Authorization": "Bearer " + token
            },
    ...
    const deleteItem = ( view_id ) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: "../Controllers/adminViewsController.php?op=deleteItem",
                    type: "POST",
                    headers: {
                        "Authorization": "Bearer " + token
                    },
    ...
    const assign = () => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: "../Controllers/adminViewsController.php?op=assign",
                    type: "POST",
                    headers: {
                        "Authorization": "Bearer " + token
                    },
                    data: { view_id: view_id, employee_id: employee_id },
                    success: function(data, status) {
                        Swal.fire({
                            toast: true,
                            position: 'top-end',
