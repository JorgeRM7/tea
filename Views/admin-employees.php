                                ...
                                <div class="modal-body">
                                    <form name="formulario" id="formulario" method="POST">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <label for="nameWithTitle" class="form-label">Apellido Paterno</label>
                                                <input type="text" id="paternal_surname" name="paternal_surname" class="form-control" placeholder="Ingresa..." required/>
                                            </div>
                                            <div class="col-md-6">
                                                <label for="nameWithTitle" class="form-label">Apellido Materno</label>
                                                <input type="text" id="maternal_surname" name="maternal_surname" class="form-control" placeholder="Ingresa..." required/>
                                            </div>
                                        </div>
                                    </form>
                                </div>
