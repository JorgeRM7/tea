                                    ...
                                    <form name="formulario" id="formulario" method="POST">
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <select class="form-select select2-container" id="route_id" name="route_id" aria-label="Default select example" onchange="show_origin(this.value)">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" id="origin" name="origin" class="form-control" placeholder="Ingresa..." readonly/>
                                                <input type="hidden" id="route_subpaths_id" name="route_subpaths_id" class="form-control"/>
                                            </div>
                                            <div class="col-md-6">
...
<script>
    ...
    $(document).ready(function() {
        const menuItem = document.querySelector('a[href="admin-routes-subpaths.php"]').parentElement;
    ...
    const store = () => {
        ...
        if (!route_id ) {
            Swal.fire({
                ...
                text: "El campo Ruta es obligatorio."
            });
            return;
        }
        ...
        if (!/^\d+(\.\d{1,2})?$/.test(price) || parseFloat(price) < 0) {
            Swal.fire({
                ...
                text: "El priceo debe ser un número positivo válido (ej. 100 o 100.50)."
            });
            return;
        }
    ...
    const index = () => {
        ...
        tabla = $('#tbllistado').dataTable({
            ...
            // "dom": 'Bfrtip',
            "ajax": {
                url: '../Controllers/adminRoutesSubpathsController.php?op=index',
                type: "get",
                headers: {
                    "Authorization": "Bearer " + token
                },
    ...
    const show = ( route_id ) => {
        $('#modal_create').modal('show');
        $.ajax({
            url: "../Controllers/adminRoutesSubpathsController.php?op=show",
            type: "POST",
            headers: {
                "Authorization": "Bearer " + token
            },
    ...
    const show_origin = ( route_id ) => {
        $('#modal_create').modal('show');
        $.ajax({
            url: "../Controllers/adminRoutesSubpathsController.php?op=show-origin",
            type: "POST",
            headers: {
                "Authorization": "Bearer " + token
            },
    ...
    const deleteItem = ( route_id ) => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: "../Controllers/adminRoutesSubpathsController.php?op=deleteItem",
                    type: "POST",
                    headers: {
                        "Authorization": "Bearer " + token
                    },
