                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 order-0 order-md-1">
                                <div class="card">
                                    <div class="card-header d-flex justify-content-between align-items-center">
                                        <h5 class="mb-0">Modulos del sistema</h5>
                                    ...
                                    <form name="formulario" id="formulario" method="POST">
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <input type="hidden" id="system_module_id" name="system_module_id" class="form-control"/>
                                            </div>
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" id="icono" name="icono" class="form-control" placeholder="Ingresa..." required/>
                                            </div>
                                        </div>
                                    </form>
                                </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        const menuItem = document.querySelector('a[href="admin-system-mudules.php"]').parentElement;
    ...
    const store = () => {
        ...
        $.ajax({
            url: "../Controllers/adminSystemModulesController.php?op=store",
            type: "POST",
            headers: {
    ...
    const index = () => {
        ...
        tabla = $('#tbllistado').dataTable({
            ...
            // "dom": 'Bfrtip',
            "ajax": {
                url: '../Controllers/adminSystemModulesController.php?op=index',
                type: "get",
                headers: {
                    "Authorization": "Bearer " + token
                },
    ...
    const show = ( system_module_id ) => {
        $('#modal_create').modal('show');
        $.ajax({
            url: "../Controllers/adminSystemModulesController.php?op=show",
            type: "POST",
            headers: {
                "Authorization": "Bearer " + token
            },
    ...
    const deleteItem = ( system_module_id ) => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: "../Controllers/adminSystemModulesController.php?op=deleteItem",
                    type: "POST",
                    headers: {
                        "Authorization": "Bearer " + token
                    },
