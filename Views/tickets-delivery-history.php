<!doctype html>
<?php ;$title = "Historial de paquetes"; ?>
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 order-0 order-md-1 mt-3">
                                <div class="card">
                                    <div class="card-header d-flex justify-content-between align-items-center">
                                        <h5 class="mb-0">Historial de Paquetes</h5>
...
<script>
    ...
    $(document).ready(function() {
        ...
        const menuItem = document.querySelector('a[href="tickets-delivery-history.php"]').parentElement;
    ...
    const index = () => {
        ...
        tabla = $('#tbllistado').dataTable({
            ...
            // "dom": 'Bfrtip',
            "ajax": {
                url: '../Controllers/ticketsDeliveriesController.php?op=index',
                type: "get",
                headers: {
    ...
    const show = ( routes_schedule_id ) => {
        ...
        $.ajax({
            url: "../Controllers/ticketsDeliveriesController.php?op=show",
            type: "POST",
            headers: {
                "Authorization": "Bearer " + token
            },
    ...
    const deleteItem = (ticket_id) => {
        ...
        Swal.fire({
            ...
            Swal.fire({
                ...
                $.ajax({
                    url: "../Controllers/ticketsDeliveriesController.php?op=deleteItem",
                    type: "POST",
    ...
    const tickets = () => {
        ...
        $.ajax({
            url: "../Controllers/ticketsDeliveriesController.php?op=tickets",
            type: "GET",
            headers: {
                "Authorization": "Bearer " + token
            },
    ...
    const  exportCSV = () => {
        ...
        $.ajax({
            url: "../Controllers/ticketsDeliveriesController.php?op=xls",
            type: "POST",
            dataType: "json",
            headers: {
                Authorization: `Bearer ${token}`,
