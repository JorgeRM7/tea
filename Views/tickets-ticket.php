                                    ...
                                    <div class="card-body">
                                        <div class="row"> 
                                            <div class="col-md-4">
                                                ...
                                                <input type="date" id="search_date" name="search_date" class="form-control" value="<?php echo date('Y-m-d'); ?>"/>
                                            </div>
                                            <div class="col-md-4">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <select class="form-select select2-container" id="search_route" name="search_route" aria-label="Default select example">
                            ...
                            <div class="col-md-6 ">
                                <div class="card mb-4 shadow-lg border-0 100 h-100" id="detailsCard" style="display:none;">
                                    ...
                                    <div class="card-footer text-end bg-light">
                                        <button class="btn btn-success fw-bold" id="confirmBtn">
...
<script>
    ...
    const schedules = () => {
        ...
        $.ajax({
            ...
            type: 'GET',
            dataType: 'json',
            data: { route_id: route_id, date: date }, // 👈 faltaba la coma
