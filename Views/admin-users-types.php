                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 order-0 order-md-1">
                                <div class="card">
                                    <div class="card-header d-flex justify-content-between align-items-center">
                                        <h5 class="mb-0">Tipos de Usuarios</h5>
                                    ...
                                    <form name="formulario" id="formulario" method="POST">
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <input type="hidden" id="user_type_id" name="user_type_id" class="form-control"/>
                                            </div>
                                            <div class="col-md-12">
                                                <label for="nameWithTitle" class="form-label">Descripción</label>
                                                <textarea id="description" name="description" class="form-control" rows="4" placeholder="Ingresa la descripción..." required></textarea>
                                            </div>
                                        </div>
                                    </form>
                                </div>
